...
- [ ] **Step 1: Write modal state and localization tests**
...
- [ ] **Step 3: Apply both direct upstream commits**
...
- [ ] **Step 4: Verify and commit the regression test**
...
- [ ] **Step 1: Write configuration and visual-shape tests**
...
- [ ] **Step 3: Implement against the current S2 surface**
...
- [ ] **Step 3: Update the two ledger rows**
...
- [ ] **Step 4: Verify and commit Batch 3 evidence**
